...
public class MainTestCPT {
	...
	public static void main(String [] arg) throws IOException, ClassNotFoundException{
		...
		String inputPath = fileToPath("test.txt");
...
//		trainingSet.loadFileSPMFFormat(inputPath, Integer.MAX_VALUE, 0, Integer.MAX_VALUE);
		...
		String optionalParameters = "splitLength:6 splitMethod:0 recursiveDividerMin:1 recursiveDividerMax:2";
...
//		sequence.addItem(new Item(34842));

		// Then we perform the prediction
		Sequence thePrediction = predictionModel.Predict(sequence);
		System.out.println("For the sequence, the prediction for the next symbol is: +" + thePrediction);
